                ...
                if(mpAtlas->KeyFramesInMap()>2)
                {
                    ...
                    if(mbInertial && mpCurrentKeyFrame->GetMap()->isImuInitialized())
                    {
                        ...
                        if(!mpCurrentKeyFrame->GetMap()->GetIniertialBA2())
                        {
                            ...
                            {
                                cout << "--- [SLAM LOG] IMU INITIALIZATION PAUSED ---" << endl;
                                cout << "Reason: You stopped moving the camera!" << endl;
                                cout << "Current motion distance between keyframes: " << dist << " m" << endl;
                                cout << "Accumulated valid motion time (mTinit): " << mTinit << " seconds" << endl;
                                cout << "System is WAITING patiently. Keep moving the camera continuously in a figure-8 pattern!" << endl;
